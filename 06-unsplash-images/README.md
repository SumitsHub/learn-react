...
- all variables are stored into special object 'import.meta.env'
- need to be prefixed with "VITE\_" e.g. VITE_SOME_KEY
- example use of env variable in application -> import.meta.env.VITE_API_KEY
