...
- create action -> don't need to do this with redux-toolkit
...
- store.js -> add modeReducer to the store
...
- App.js -> accessing modal state value
...
- CartContainer.js -> open modal on click of clear cart
...
// NOTE -> "builder callback" notation for extraReducer provided below
